    ...
    try:
        with open("./queries/insert_passengers.sql", "w", encoding="utf-8") as f:
            ...
            with conn.cursor() as cursor:
                ...
                insert_query = \
                    "INSERT INTO passenger (first_name, last_name, date_of_birth, nationality, passport_number) VALUES "
                values = []
                ...
                for i in range(1000000):
                    ...
                    values.append(
                        f"('{first_name}', '{last_name}', '{date_of_birth}', '{nationality}', '{passport_number}')")
